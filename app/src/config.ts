...
export const supportedChains = [polygon, shibuya, astar, shiden] satisfies Chain[];
...
export const scanList: Record<SupportedContracts, string> = {
  astar: "https://astar.subscan.io/account/0x26DA9C05A9f7bcEFb9e342Bb35FA8aE338F9cCed?tab=transfer",
  shiden: "https://shiden.subscan.io/account/0x7F3D0a403dBAc1496DCa0D5cFb3196e9830e0fB8",
  polygon: "https://polygonscan.com/address/0xe29BFb891Db927E88134846DC34B482dd7f875f0",
  shibuya: "https://shibuya.subscan.io/account/0xd546Fa7F58d247C8c03d6b97525eE259ac50b63F",
};
